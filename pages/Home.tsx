...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-24 pb-24 overflow-hidden">
      ...
      {/* Video Modal Popup */}
      {isModalOpen && videoId && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-12 bg-gray-950/98 backdrop-blur-md animate-fade-in">
          <button onClick={() => setIsModalOpen(false)} className="absolute top-8 right-8 p-4 bg-gray-900/50 hover:bg-primary hover:text-gray-950 rounded-full text-white transition-all z-[110] border border-white/10 group shadow-2xl">
            <X size={28} className="group-hover:rotate-90 transition-transform" />
          </button>
          
          <div className="w-full max-w-6xl aspect-video rounded-3xl overflow-hidden bg-black shadow-2xl animate-zoom-in border border-white/10">
            <iframe 
              width="100%"
              height="100%"
